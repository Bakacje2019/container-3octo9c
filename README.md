...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3octo9c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3octo9c.containers.anotherwebservice.com/
...
```
git clone git@github.com:Bakacje2019/container-3octo9c.git
cd container-3octo9c
```
...
```
docker attach container-3octo9c
```
